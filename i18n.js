...
(function () {
  ...
  const TRANSLATIONS = {
    de: {
      ...
      'how.s3.desc': 'Karte, PayPal – fertig. Der Zugangscode kommt sofort per Mail. Keine Überraschungen.',
    ...
    en: {
      ...
      'how.s3.desc': 'Card, PayPal — done. The access code arrives instantly by email. No surprises.',
